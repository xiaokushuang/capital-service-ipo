...
<template>
  <div class="container">
    ...
    <el-col :span='18'>
     <el-row :gutter="24">
        <el-col :span='8'>
            <el-select ref="selectTreeIndex" v-model="formLabelAlign.type" placeholder="标题关键字（包含全部）"  
        ...
        date3:"",  -->
        <el-col :span='8'>
            <el-select ref="selectTreeIndex" v-model="formLabelAlign.type" placeholder="标题关键字（任一包含）"  
            size="small full" @visible-change="calls">
              <el-option :label="formLabelAlign.type" :value="formLabelAlign.type" >
        ...
        <el-col :span='8'>
            <el-select ref="selectTreeIndex" v-model="formLabelAlign.type" placeholder="标题关键字（全不包含）"  
            size="small full" @visible-change="calls">
              <el-option :label="formLabelAlign.type" :value="formLabelAlign.type" >
                <el-tree :data="getSFCRegion" show-checkbox node-key="id" ref="tree4" highlight-current 
                @check-change="handleNodeClick2" :props="defaultProps"></el-tree>  
              </el-option>
              <el-col :span="24" class='selectFull'>
                <el-button type="primary" size="mini" @click="sure">确定</el-button>
      ...
      <el-row :gutter="24">
        <el-col :span='8'> 
             <el-input size='small full' v-model="formLabelAlign.input2"  placeholder="证券简称/代码"></el-input>
        </el-col>
        <el-col :span='8'> 
            <el-select ref="selectTreeIndex" v-model="formLabelAlign.type" placeholder="重组进程"  
            size="small full" @visible-change="calls">
              <el-option :label="formLabelAlign.type" :value="formLabelAlign.type" >
                <el-tree :data="getSFCRegion" show-checkbox node-key="id" ref="tree5" highlight-current 
                @check-change="handleNodeClick2" :props="defaultProps"></el-tree>  
              </el-option>
              <el-col :span="24" class='selectFull'>
                <el-button type="primary" size="mini" @click="sure">确定</el-button>
         ...
         <el-col :span='8'> 
            <el-select ref="selectTreeIndex" v-model="formLabelAlign.type" placeholder="证监会行业"  
            size="small full" @visible-change="calls">
              <el-option :label="formLabelAlign.type" :value="formLabelAlign.type" >
                <el-tree :data="getSFCRegion" show-checkbox node-key="id" ref="tree6" highlight-current 
                @check-change="handleNodeClick2" :props="defaultProps"></el-tree>  
              </el-option>
              <el-col :span="24" class='selectFull'>
                <el-button type="primary" size="mini" @click="sure">确定</el-button>
      ...
      <el-row :gutter="20">
        <el-col :span="24">  
          ...
          <el-table :data="data1" border style="width: 100%" max-height="400" sortable="custom" 
          @sort-change="sortChange" @selection-change="handleSelectionChange" size="medium">
            <el-table-column align="center" type="index" label="序号" width="70px"></el-table-column>
             <el-table-column align="center" prop="companyName" label="公司" min-width="80" sortable></el-table-column>
            <el-table-column align="center" prop="securityName" label="案例标题" min-width="240" sortable></el-table-column>
            <el-table-column align="center" prop="financeDate" label="重组进程" min-width="110" sortable></el-table-column>
            <el-table-column align="center" prop="pIndName004" label="重组类型" min-width="90"></el-table-column>
            <el-table-column align="center" prop="cityName" label="重组方式" min-width="90"></el-table-column>
            <el-table-column align="center" prop="address" label="重组目的" min-width="90"></el-table-column>
