<template>
  <div class="container">
    ...
    <el-row :gutter="20">
      <el-col :span="6">
        <el-multiple-selection ref="belongsPlateTree" id="belongsPlateTree" placeholder="所属板块" @sure-click="sure" size="small full"
          :search-menu="true" node-key="value" :tree-data="belongsPlateList" :default-props="defaultProps"
          :default-all-show="false" :all-select="allSelect"></el-multiple-selection>
      </el-col>
      <!-- 注册地 -->
      <el-col :span="6">
        <el-multiple-selection ref="areaTree" id="areaTree" placeholder="注册地" @sure-click="sure" size="small full"
          :search-menu="true" node-key="originContent" :tree-data="areaList" :default-props="defaultProps1"
          :default-all-show="false" :all-select="allSelect"></el-multiple-selection>
      </el-col>
    ...
    <el-row>
      <el-col :span="24">
        <el-table :data="data" style="width: 100%" :height="tableHeight" class="paddingControl" border tooltip-effect="dark" ref="multipleSelection"
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.tableHeight = document.documentElement.clientHeight+0-320;
          ...
          if (approveStatus != null && approveStatus != '') {
            switch (approveStatus) {
              ...
              case '06':
                ...
                break;
              case '09':
                appLabel = approveStatus.replace("09", "<span style='color:#0099cc'>注册生效</span>");
                break;
              case '10':
              ...
              case '05':
                ...
                break;
              case '99':
                appLabel = approveStatus.replace("99", "最近一周终止审查<span style='color:#0099cc'>(终止)</span>");
                break;
            }
          }
          if ('unit' == viewType) {
...
<style>
  ...
  .el-select-dropdown .el-input__suffix:hover {
    cursor: pointer;
  }
