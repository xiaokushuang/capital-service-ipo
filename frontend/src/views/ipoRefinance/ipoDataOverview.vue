            ...
            <el-col :span="12">
              <div id="table1">
                <el-table :data="tableTop" border show-summary style="width: 100%">
                  ...
                  <el-table-column label="核准制" align="center" :render-header="renderHeader">
                  ...
                  <el-table-column label="注册制" align="center" :class-name="abc">
            ...
            <el-tabs v-model="activeName">
              <el-tab-pane label="保荐机构" name="first">
                <div rightTable>
                  ...
                  <!-- <el-table ref="table0" :data="table1" border style="width:100%;margin:0 auto; border-right:1px solid #ddd;border-bottom:1px solid #ddd;"
                  @sort-change="sortChange($event,1)">
                    <el-table-column align="center" label="序号" prop="num"  min-width="10%" :class-name="borderStyle"></el-table-column>
                    <el-table-column align="left" label="保荐机构" prop="label" min-width="30%"  :class-name="borderStyleText"></el-table-column>
                    <el-table-column align="center" label="沪主板" prop="hzbCount" min-width="10%" sortable :class-name="borderStyle"></el-table-column>
                    <el-table-column align="center" label="中小板" prop="zxbCount" min-width="10%" sortable :class-name="borderStyle"></el-table-column>
                    <el-table-column align="center" label="创业板" prop="cybCount" min-width="10%" sortable :class-name="borderStyle"></el-table-column>
                    <el-table-column align="center" label="科创板" prop="kcCount" min-width="10%" sortable :class-name="borderStyle"></el-table-column>
                    <el-table-column align="center" label="合计"  prop="totalCount" min-width="10%" sortable :class-name="borderStyle"></el-table-column>
                    <el-table-column align="center" label="市场比" min-width="10%" sortable>
                        <template slot-scope="scope">
                  ...
                  <div rightTable>
                    <ipo-data-overview-table-show ref="ipoDataOverviewShow" :id="tabName2" :industrySelect="industrySelect" :areaSelect="areaSelect"></ipo-data-overview-table-show>
                      <!-- <el-table
                          ...
                          :data="table2"
                          border
                          style="width:100%;margin:0 auto; border-right:1px solid #ddd;border-bottom:1px solid #ddd;">
