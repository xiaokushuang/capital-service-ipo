  ...
  methods: {
    ...
    handelChange(val) {
      ...
      if(this.singleAndMultiplDdata.tabList.length==1){
        console.log('父组件',this.$parent.$parent.$parent.initQuestionData)
        console.log('letterId',this.singleAndMultiplDdata.o_letterId)
      ...
      if(this.singleAndMultiplDdata.tabList.length>1){
                    this.$parent.$parent.$parent.$parent.$parent.initQuestionData(
                    this.singleAndMultiplDdata.o_letterId,
                    this.radioRealVal,
                    this.checkboxRealGroup,
                    this.onlyShowAnswerFlag
    ...
    handelMoreChange(val,current) {
      ...
      if(this.singleAndMultiplDdata.tabList.length>1){
                    this.$parent.$parent.$parent.$parent.$parent.initOnlyQuestionData(
                    this.singleAndMultiplDdata.o_letterId,
                    this.radioRealVal,
                    this.checkboxRealGroup,
                    this.onlyShowAnswerFlag
