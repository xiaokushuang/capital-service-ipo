        ...
        <div>
          ...
          <li class="clear" v-if="companyProfileList.companyProfileList&&companyProfileList.companyProfileList.issueCondition !=''" style="margin-bottom:10px;position:relative" >
            ...
            <div v-else style="color: #333333;float:left;display:inline-block;width: 80%;margin-left: 1.6%;">
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('101')>-1">一般企业标准一：预计市值不低于人民币<span style="color:red">10亿元</span>，最近两年净利润均为正且累计净利润不低于人民币<span style="color:red">5000万元</span>，或者预计市值不低于人民币<span style="color:red">10亿元</span>，最近一年净利润为正且营业收入不低于人民币<span style="color:red">1亿元</span></div>
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('102')>-1">一般企业标准二：预计市值不低于人民币<span style="color:red">15亿元</span>，最近一年营业收入不低于人民币<span style="color:red">2亿元</span>，且最近三年累计研发投入占最近三年累计营业收入的比例不低于<span style="color:red">15%</span></div>
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('103')>-1">一般企业标准三：预计市值不低于人民币<span style="color:red">20亿元</span>，最近一年营业收入不低于人民币<span style="color:red">3亿元</span>，且最近三年经营活动产生的现金流量净额累计不低于人民币<span style="color:red">1亿元</span></div>
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('104')>-1">一般企业标准四：预计市值不低于人民币<span style="color:red">30亿元</span>，且最近一年营业收入不低于人民币<span style="color:red">3亿元</span></div>
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('105')>-1">一般企业标准五：预计市值不低于人民币<span style="color:red">40亿元</span>，主要业务或产品需经国家有关部门批准，市场空间大，目前已取得阶段性成果。医药行业企业需至少有一项核心产品获准开展二期临床试验，其他符合科创板定位的企业需具备明显的技术优势并满足相应条件</div>
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('201')>-1">红筹企业（境外未上市）标准一：符合相关规定的红筹企业，预计市值不低于人民币<span style="color:red">100亿元</span></div>
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('202')>-1">红筹企业（境外未上市）标准二：符合相关规定的红筹企业，预计市值不低于人民币<span style="color:red">50亿元</span>，且最近一年营业收入不低于人民币<span style="color:red">5亿元</span></div>
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('801')>-1">红筹企业（境外已上市）标准一：市值不低于<span style="color:red">2000亿元</span>人民币</div>
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('802')>-1">红筹企业（境外已上市）标准二：市值<span style="color:red">2000亿元</span>人民币以上，且拥有自主研发、国际领先技术，科技创新能力较强，同行业竞争中处于相对优势地位。</div>
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('301')>-1">表决权差异标准一：发行人具有表决权差异安排的，预计市值不低于人民币<span style="color:red">100亿元</span></div>
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('302')>-1">表决权差异标准二：发行人具有表决权差异安排的，预计市值不低于人民币<span style="color:red">50亿元</span>，且最近一年营业收入不低于人民币<span style="color:red">5亿元</span></div>

              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('401')>-1">标准一：市值不低于<span style="color:red">2亿元</span>，最近两年净利润均不低于<span style="color:red">2亿元</span>1500万元且加权平均净资产收益率平均不低于<span style="color:red">8%</span>，或者最近一年净利润不低于<span style="color:red">2500万元</span>且加权平均净资产收益率不低于<span style="color:red">8%</span></div>
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('402')>-1">标准二：市值不低于<span style="color:red">4亿元</span>，最近两年营业收入平均不低于<span style="color:red">1亿元</span>且最近一年营业收入增长率不低于<span style="color:red">30%</span>，最近一年经营活动产生的现金流量净额为正</div>
              ...
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('602')>-1">红筹企业标准二：预计市值不低于人民币<span style="color:red">50亿元</span>，最近一年净利润为正且营业收入不低于人民币<span style="color:red">5亿元</span></div>
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('701')>-1">特殊股权企业标准一：预计市值不低于人民币<span style="color:red">100亿元</span>，且最近一年净利润为正</div>
              <div v-if="companyProfileList.companyProfileList.issueCondition&&companyProfileList.companyProfileList.issueCondition.indexOf('702')>-1">特殊股权企业标准二：预计市值不低于人民币<span style="color:red">50亿元</span>，最近一年净利润为正且营业收入不低于人民币<span style="color:red">5亿元</span></div>
            </div>
          </li>
