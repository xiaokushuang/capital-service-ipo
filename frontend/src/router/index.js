...
export const constantRouterMap = [
  ...
  {// financeStatistics/financeSearch
    ...
    children: [
      ...
      {
        path:'/ipoDataOverviewDetailPopWin',
        component: _import('components-demo/ipoDataOverviewDetailPopWinComponent'),
      ...
      },
      {
        ...
        meta: {title: 'ipo在审项目详情弹窗', noCache: true}
      },
			{
        path:'confirmPopWin',
        component: _import('ipoCase/confirmPopWinComponent'),
        name:'confirmPopWin',
        meta: {title: '违规案例弹窗', noCache: true}
      },
      {
        path: 'securitiesInit',
