...
//
    ...
    var activateTheme = function (btns) {
        ...
        currentTheme = demo_settings.theme;
    }
...
//
    ...
    var demo_themes = [
        { name: 'silver',  title: '默认', img: 'static/images/themes/silver.png' },
        { name: 'default', title: '黑色', img: 'static/images/themes/default.png' },
        { name: 'asphalt', title: '青色', img: 'static/images/themes/asphalt.png' },
        { name: 'purple-hills', title: '紫色', img: 'static/images/themes/purple-hills.png' },
//        { name: 'adminflare',  title: 'Adminflare', img: 'static/images/themes/adminflare.png' },
        { name: 'dust',  title: '橘色', img: 'static/images/themes/dust.png' },
        { name: 'frost',  title: '蓝色', img: 'static/images/themes/frost.png' },
//        { name: 'fresh',  title: 'Fresh', img: 'static/images/themes/fresh.png' },
//        { name: 'clean',  title: '清爽', img: 'static/images/themes/clean.png' },
//        { name: 'white',  title: '白色', img: 'static/images/themes/white.png' },
    ];
...
//            return false;
        ...
        $('#demo-themes .demo-theme').on('click', function () {
            ...
            saveDemoSettings();
            activateTheme($('#main-menu .btn-outline'));
            //需求 2683 点击样式设置中的某一项，样式窗口关闭  Wang Guili & Gerry
            toggleSettingMenu();
            return false;
        });
...
function toggleSettingMenu() {
	...
	$('#demo-settings').toggleClass('open');
	// 2683 去掉样式页面的关闭按钮 Wang Guili & Gerry
	/*if ($('#demo-settings').hasClass("open")) {
...
function activeMenu(menuIndex) {
    ...
    $('#newbars>ul.nav_tamp>li').eq(menuIndex.idx-1).addClass('clicks').siblings().removeClass('clicks');
    $('#news-body ul').eq(menuIndex.idx-1).find('li[title='+menuIndex.name+']').addClass('active').siblings().removeClass('active');
    $('.antd').text(menuIndex.name)
}