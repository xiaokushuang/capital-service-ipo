...
public class CommonService extends BaseService {
	...
	public Map<String,Object> getAnnoById(String id){
		if (StringUtils.isBlank(id)) {
			return null;
		}
		String accessToken = getGuiAccessToken();
		String urls = guiBaseUrl + "/announcement/announcement/api/postSearchIndex?access_token=" + accessToken;
		MultiValueMap<String, String> param = new LinkedMultiValueMap<>();
		param.add("indexId", id);
		ParameterizedTypeReference<Map<String, Object>> responseType = new ParameterizedTypeReference<Map<String, Object>>() {
		};
		Map<String, Object> map = restClient.post(urls, param, responseType);
		String jsonString = JsonUtil.toJson(map.get("result"));
		Map<String, Object> dataMap = JsonUtil.fromJson(jsonString, Map.class);
		return dataMap;
	}
